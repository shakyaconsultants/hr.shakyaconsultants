...
payrollRoutes.get('/dashboard/enterprise', authorize(PAYROLL_PERMISSIONS.READ), getEnterpriseDashboard);
...
payrollRoutes.post('/salary-structures', authorize(PAYROLL_PERMISSIONS.CREATE), createSalaryStructure);
payrollRoutes.get('/salary-structures/:id', authorize(PAYROLL_PERMISSIONS.READ), getSalaryStructure);
payrollRoutes.patch('/salary-structures/:id', authorize(PAYROLL_PERMISSIONS.UPDATE), updateSalaryStructure);
payrollRoutes.delete('/salary-structures/:id', authorize(PAYROLL_PERMISSIONS.DELETE), deleteSalaryStructure);
...
payrollRoutes.post('/payroll-runs/:id/process', authorize(PAYROLL_PERMISSIONS.PROCESS), processPayrollRun);
payrollRoutes.post('/payroll-runs/:id/submit', authorize(PAYROLL_PERMISSIONS.UPDATE), submitPayrollRun);
payrollRoutes.post('/payroll-runs/:id/lock', authorize(PAYROLL_PERMISSIONS.UPDATE), lockPayrollRun);
payrollRoutes.post('/payroll-runs/:id/unlock', authorize(PAYROLL_PERMISSIONS.UPDATE), unlockPayrollRun);
payrollRoutes.get('/payroll-runs/:id/payslips', authorize(PAYSLIP_PERMISSIONS.READ), listPayrollPayslips);
...
payrollRoutes.patch('/salary-revisions/:id', authorize(PAYROLL_PERMISSIONS.UPDATE), updateSalaryRevision);
payrollRoutes.post('/salary-revisions/:id/submit', authorize(PAYROLL_PERMISSIONS.UPDATE), submitSalaryRevision);
...
payrollRoutes.get('/employees/:employeeId/salary-history', authorize(PAYROLL_PERMISSIONS.READ), getEmployeeSalaryHistory);
