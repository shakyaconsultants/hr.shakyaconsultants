...
export const WORKSPACE_WIDGET_CATALOG: WidgetCatalogEntry[] = [
  {
    slug: WORKSPACE_WIDGET.TODAY_TASKS,
    name: "Today's Tasks",
    description: 'Tasks due today and in progress',
    defaultSortOrder: 1,
    defaultColumnSpan: 1,
    requiredPermission: WORKSPACE_PERMISSIONS.READ,
  },
  {
    slug: WORKSPACE_WIDGET.MY_PROJECTS,
    name: 'My Projects',
  ...
  {
    slug: WORKSPACE_WIDGET.UPCOMING_DEADLINES,
    name: 'Upcoming Deadlines',
    description: 'Tasks and milestones due soon',
    defaultSortOrder: 3,
    defaultColumnSpan: 1,
    requiredPermission: WORKSPACE_PERMISSIONS.READ,
  },
  {
    slug: WORKSPACE_WIDGET.RECENT_NOTIFICATIONS,
    name: 'Recent Notifications',
    description: 'Latest notifications',
    defaultSortOrder: 4,
    defaultColumnSpan: 1,
    requiredPermission: WORKSPACE_PERMISSIONS.NOTIFICATION_READ,
  },
  {
    slug: WORKSPACE_WIDGET.ANNOUNCEMENTS,
    name: 'Company Announcements',
    description: 'Latest company announcements',
    defaultSortOrder: 5,
    defaultColumnSpan: 1,
    requiredPermission: WORKSPACE_PERMISSIONS.ANNOUNCEMENT_READ,
  },
  {
    slug: WORKSPACE_WIDGET.QUICK_LINKS,
    name: 'Quick Links',
  ...
  {
    slug: WORKSPACE_WIDGET.ATTENDANCE_SUMMARY,
    name: 'Attendance Summary',
    description: 'Attendance overview (coming soon)',
    defaultSortOrder: 7,
    defaultColumnSpan: 1,
    requiredPermission: WORKSPACE_PERMISSIONS.READ,
    isPlaceholder: true,
  ...
  {
    slug: WORKSPACE_WIDGET.LEAVE_BALANCE,
    name: 'Leave Balance',
    description: 'Leave balance overview (coming soon)',
    defaultSortOrder: 8,
    defaultColumnSpan: 1,
    requiredPermission: WORKSPACE_PERMISSIONS.READ,
    isPlaceholder: true,
  ...
  {
    slug: WORKSPACE_WIDGET.PAYSLIPS,
    name: 'Payslips',
    description: 'Recent payslips (coming soon)',
    defaultSortOrder: 9,
    defaultColumnSpan: 1,
    requiredPermission: WORKSPACE_PERMISSIONS.READ,
    isPlaceholder: true,
...
function filterByPermissions(
  ...
  return catalog.filter(
    (entry) => !entry.requiredPermission || permSet.has(entry.requiredPermission),
  );
}
