...
export const CONFIGURATION_SECTIONS: ConfigurationSection[] = [
  ...
  },
  {
    id: 'company',
    name: 'Company',
    description: 'Company profile and locale',
    group: SETTING_GROUP.COMPANY,
  },
  {
    id: 'branding',
    name: 'Branding',
    description: 'Logo, colors, and theme',
    group: SETTING_GROUP.BRANDING,
  },
  {
    id: 'organization',
    name: 'Organization',
    description: 'Org structure defaults',
    group: SETTING_GROUP.ORGANIZATION,
  },
  {
    id: 'attendance',
    name: 'Attendance',
    description: 'Attendance policies',
  ...
  },
  {
    id: 'recruitment',
    name: 'Recruitment',
    description: 'Hiring pipeline settings',
    group: SETTING_GROUP.RECRUITMENT,
  },
  {
    id: 'projects',
    name: 'Projects',
  ...
  },
  {
    ...
    group: SETTING_GROUP.NOTIFICATIONS,
  },
  {
    id: 'email',
    name: 'Email',
    description: 'SMTP and email delivery',
    group: SETTING_GROUP.EMAIL,
  },
  {
    id: 'storage',
    name: 'Storage',
    description: 'File storage and Cloudinary',
    group: SETTING_GROUP.STORAGE,
  },
  {
    id: 'security',
    name: 'Security',
    description: 'Password policy and sessions',
  ...
  },
  {
    id: 'reports',
    name: 'Reports',
    description: 'Reporting defaults',
...
const def = (
  ...
  group: string,
  options?: Partial<
    Pick<ConfigurationSettingDefinition, 'category' | 'validation' | 'encrypted' | 'isPublic'>
  >,
...
export const CONFIGURATION_CATALOG: ConfigurationSettingDefinition[] = [
  ...
  def(
    ...
    'Fiscal Year Start',
    'Month fiscal year begins (1-12)',
    SETTING_VALUE_TYPE.NUMBER,
    4,
    SETTING_GROUP.COMPANY,
  ),
  def(
  ...
  // Organization
  def(
    'organization.employee_number_prefix',
  ...
  def(
    'organization.department_code_prefix',
    'Department Code Prefix',
    'Prefix for auto-generated department codes',
    SETTING_VALUE_TYPE.STRING,
    'DEPT',
    SETTING_GROUP.ORGANIZATION,
  ),
  def(
    'organization.designation_code_prefix',
    'Designation Code Prefix',
    'Prefix for auto-generated designation codes',
    SETTING_VALUE_TYPE.STRING,
    'DESG',
    SETTING_GROUP.ORGANIZATION,
  ),
  def(
    'organization.designation_department_required',
    'Designation Department Required',
    'Require department mapping on designations',
    SETTING_VALUE_TYPE.BOOLEAN,
    false,
    SETTING_GROUP.ORGANIZATION,
  ),
  def(
    'organization.require_branch',
    'Require Branch',
    'Branch required on employee profile',
    SETTING_VALUE_TYPE.BOOLEAN,
    true,
    SETTING_GROUP.ORGANIZATION,
  ),
  def(
    'organization.code_pad_length',
    'Code Pad Length',
    'Zero-pad length for auto-generated master data codes',
    SETTING_VALUE_TYPE.NUMBER,
    4,
    SETTING_GROUP.ORGANIZATION,
  ),
  def(
    'organization.code_include_year',
    'Code Include Year',
    'Include YY year segment in generated codes',
    SETTING_VALUE_TYPE.BOOLEAN,
    false,
    SETTING_GROUP.ORGANIZATION,
  ),
  def(
    'organization.code_include_month',
    'Code Include Month',
    'Include MM month segment in generated codes',
    SETTING_VALUE_TYPE.BOOLEAN,
    false,
    SETTING_GROUP.ORGANIZATION,
  ),
  def(
    'organization.branch_code_prefix',
    'Branch Code Prefix',
    'Prefix for auto-generated branch codes',
    SETTING_VALUE_TYPE.STRING,
    'BR',
    SETTING_GROUP.ORGANIZATION,
  ),
  def(
    'organization.job_role_code_prefix',
    'Job Role Code Prefix',
    'Prefix for auto-generated job role codes',
    SETTING_VALUE_TYPE.STRING,
    'ROLE',
    SETTING_GROUP.ORGANIZATION,
  ),
  def(
    'organization.office_location_code_prefix',
    'Office Location Code Prefix',
    'Prefix for auto-generated office location codes',
    SETTING_VALUE_TYPE.STRING,
    'LOC',
    SETTING_GROUP.ORGANIZATION,
  ),
  def(
    'organization.work_shift_code_prefix',
    'Work Shift Code Prefix',
    'Prefix for auto-generated work shift codes',
    SETTING_VALUE_TYPE.STRING,
    'SHIFT',
    SETTING_GROUP.ORGANIZATION,
  ),
  def(
    'organization.holiday_module_code_prefix',
    'Holiday Module Code Prefix',
    'Prefix for auto-generated holiday module codes',
    SETTING_VALUE_TYPE.STRING,
    'HMOD',
    SETTING_GROUP.ORGANIZATION,
  ),
  def(
    'organization.salary_grade_code_prefix',
    'Salary Grade Code Prefix',
    'Prefix for auto-generated salary grade codes',
    SETTING_VALUE_TYPE.STRING,
    'SG',
    SETTING_GROUP.ORGANIZATION,
  ),
  def(
    'organization.leave_type_code_prefix',
    'Leave Type Code Prefix',
    'Prefix for auto-generated leave type codes',
    SETTING_VALUE_TYPE.STRING,
    'LV',
    SETTING_GROUP.ORGANIZATION,
  ),
  def(
    'organization.project_category_code_prefix',
    'Project Category Code Prefix',
    'Prefix for auto-generated project category codes',
    SETTING_VALUE_TYPE.STRING,
    'PCAT',
    SETTING_GROUP.ORGANIZATION,
  ),
  def(
    'organization.technology_code_prefix',
    'Technology Code Prefix',
    'Prefix for auto-generated technology codes',
    SETTING_VALUE_TYPE.STRING,
    'TECH',
    SETTING_GROUP.ORGANIZATION,
  ),
  def(
    'organization.skill_code_prefix',
    'Skill Code Prefix',
    'Prefix for auto-generated skill codes',
    SETTING_VALUE_TYPE.STRING,
    'SKL',
    SETTING_GROUP.ORGANIZATION,
  ),
  ...
  def(
    ...
    'Late Threshold',
    'Minutes after which punch is late',
    SETTING_VALUE_TYPE.NUMBER,
    15,
    SETTING_GROUP.ATTENDANCE,
  ),
  ...
  // Leave
  def(
    'leave.carry_forward_enabled',
    'Carry Forward',
    'Allow leave balance carry forward',
    SETTING_VALUE_TYPE.BOOLEAN,
    true,
    SETTING_GROUP.LEAVE,
  ),
  def(
    'leave.max_carry_forward_days',
  ...
  def(
    'payroll.pay_day',
    'Pay Day',
    'Day of month for salary disbursement',
    SETTING_VALUE_TYPE.NUMBER,
    1,
  ...
  def(
    'payroll.pf_enabled',
    'PF Enabled',
    'Provident fund deduction enabled',
    SETTING_VALUE_TYPE.BOOLEAN,
    true,
    SETTING_GROUP.PAYROLL,
  ),
  ...
  // Recruitment
  def(
    'recruitment.auto_reject_days',
    'Auto Reject Days',
    'Days before stale candidates auto-reject',
    SETTING_VALUE_TYPE.NUMBER,
    90,
    SETTING_GROUP.RECRUITMENT,
  ),
  def(
    'recruitment.offer_expiry_days',
    'Offer Expiry Days',
  ...
  def(
    'recruitment.resume_max_size_mb',
    'Resume Max Size (MB)',
  ...
  // Projects
  def(
    'projects.default_sprint_duration',
    'Default Sprint Duration',
    'Sprint length in days',
    SETTING_VALUE_TYPE.NUMBER,
    14,
    SETTING_GROUP.PROJECTS,
  ),
  def(
    'projects.task_auto_assign',
    'Task Auto Assign',
    'Auto-assign tasks to project lead',
    SETTING_VALUE_TYPE.BOOLEAN,
    false,
    SETTING_GROUP.PROJECTS,
  ),
  def(
    'projects.time_tracking_enabled',
    'Time Tracking',
    'Enable work log time tracking',
    SETTING_VALUE_TYPE.BOOLEAN,
    true,
    SETTING_GROUP.PROJECTS,
  ),
  ...
  def(
    'sales.default_pipeline',
    'Default Pipeline',
    'Default sales pipeline slug',
    SETTING_VALUE_TYPE.STRING,
    'default',
    SETTING_GROUP.SALES,
  ),
  ...
  // Communication
  def(
    'communication.announcement_expiry_days',
    'Announcement Expiry',
    'Default announcement expiry in days',
    SETTING_VALUE_TYPE.NUMBER,
    30,
    SETTING_GROUP.COMMUNICATION,
  ),
  def(
    'communication.allow_direct_messages',
    'Direct Messages',
    'Allow employee direct messaging',
    SETTING_VALUE_TYPE.BOOLEAN,
    true,
    SETTING_GROUP.COMMUNICATION,
  ),
  ...
  def(
    ...
    'Report Retention',
    'Days to retain generated reports',
    SETTING_VALUE_TYPE.NUMBER,
    90,
    SETTING_GROUP.REPORTS,
  ),
