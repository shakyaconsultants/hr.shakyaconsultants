...
import { ATTENDANCE_NOTIFICATION_JOB } from '@modules/attendance/constants/attendance.constants.js';
import type { AttendanceActorContext } from '@modules/approval/types/approval.types.js';

export const AttendanceEventService = {
  async publishActivity(context: AttendanceActorContext, input: {
    activityType: string;
    description: string;
    entityType?: string;
    entityId?: string;
  ...
  async notify(context: AttendanceActorContext, input: {
    ...
    await NotificationRepository.create(
      {
        ...
        entityType: input.entityType,
        entityId: input.entityId,
        category: input.category ?? 'attendance',
...
export { ATTENDANCE_NOTIFICATION_JOB };
