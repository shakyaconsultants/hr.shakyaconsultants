...
employeeRoutes.get('/check-email', authorize(EMPLOYEE_PERMISSIONS.CREATE), checkEmployeeEmail);
...
employeeRoutes.post(
  '/:employeeId/send-password-reset',
  authorize(EMPLOYEE_PERMISSIONS.UPDATE),
  sendEmployeePasswordResetEmail,
);
...
employeeRoutes.get(
  ...
  authorize(EMPLOYEE_PERMISSIONS.DOCUMENTS_READ),
  listDocuments,
);
employeeRoutes.post(
  '/:employeeId/documents',
...
employeeRoutes.get(
  '/:employeeId/upload/signed-params',
  authorize(EMPLOYEE_PERMISSIONS.DOCUMENTS_MANAGE),
  getSignedUploadParams,
);
...
employeeRoutes.get(
  ...
  authorize(EMPLOYEE_PERMISSIONS.READ),
  listEmergencyContacts,
);
employeeRoutes.post(
  '/:employeeId/emergency-contacts',
...
employeeRoutes.get(
  ...
  authorize(EMPLOYEE_PERMISSIONS.EDUCATION_READ),
  listEducation,
);
employeeRoutes.post(
  '/:employeeId/education',
  authorize(EMPLOYEE_PERMISSIONS.EDUCATION_MANAGE),
  createEducation,
);
employeeRoutes.patch(
  '/:employeeId/education/:id',
  authorize(EMPLOYEE_PERMISSIONS.EDUCATION_MANAGE),
  updateEducation,
);
employeeRoutes.delete(
...
employeeRoutes.get(
  ...
  authorize(EMPLOYEE_PERMISSIONS.EXPERIENCE_READ),
  listExperience,
);
employeeRoutes.post(
  '/:employeeId/experience',
  authorize(EMPLOYEE_PERMISSIONS.EXPERIENCE_MANAGE),
  createExperience,
);

employeeRoutes.get(
  '/:employeeId/bank-details',
  authorize(EMPLOYEE_PERMISSIONS.BANK_READ),
  listBankDetails,
);
employeeRoutes.post(
  '/:employeeId/bank-details',
  authorize(EMPLOYEE_PERMISSIONS.BANK_MANAGE),
  createBankDetails,
);
...
employeeRoutes.post(
  '/:employeeId/skills',
  authorize(EMPLOYEE_PERMISSIONS.SKILLS_MANAGE),
  createSkill,
);

employeeRoutes.get(
  '/:employeeId/certifications',
  authorize(EMPLOYEE_PERMISSIONS.CERTIFICATIONS_READ),
  listCertifications,
);
employeeRoutes.post(
  '/:employeeId/certifications',
  authorize(EMPLOYEE_PERMISSIONS.CERTIFICATIONS_MANAGE),
  createCertification,
);
...
employeeRoutes.post(
  '/:employeeId/assets',
  authorize(EMPLOYEE_PERMISSIONS.ASSETS_MANAGE),
  createAsset,
);
employeeRoutes.post(
  '/:employeeId/assets/:id/return',
  authorize(EMPLOYEE_PERMISSIONS.ASSETS_MANAGE),
  returnAsset,
);
...
employeeRoutes.get(
  '/:employeeId/managers',
  authorize(EMPLOYEE_PERMISSIONS.MANAGERS_READ),
  listManagers,
);
employeeRoutes.get(
...
employeeRoutes.post(
  '/:employeeId/managers',
  authorize(EMPLOYEE_PERMISSIONS.MANAGERS_MANAGE),
  assignManager,
);
employeeRoutes.delete(
  '/:employeeId/managers/:id',
  authorize(EMPLOYEE_PERMISSIONS.MANAGERS_MANAGE),
  endManagerRelationship,
);
employeeRoutes.get(
  '/:employeeId/timeline',
  authorize(EMPLOYEE_PERMISSIONS.TIMELINE_READ),
  listTimeline,
);
