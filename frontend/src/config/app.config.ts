...
export const ROUTES = {
  ...
  WORKSPACE_LEAVE_APPLY: '/workspace/leave/apply',
  WORKSPACE_LEAVE_REQUESTS: '/workspace/leave/requests',
  WORKSPACE_LEAVE_BALANCE: '/workspace/leave/balance',
  WORKSPACE_RESIGNATION: '/workspace/leave/resignation',
  workspaceProjectTasks: (projectId: string) => `/workspace/tasks?project=${projectId}`,
  REPORTS: '/reports',
