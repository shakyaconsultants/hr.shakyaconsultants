...
import { formatStage } from '@/features/recruitment/utils/recruitment-display.util';
    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Pipeline overview, interviews, offers, and conversion metrics.
          </p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard
          ...
          value={(data.todaysInterviews ?? []).length}
        />
        <StatCard
          icon={Calendar}
        ...
        <StatCard
          ...
          value={(data.offersPending ?? []).length}
        />
        <StatCard
          icon={TrendingUp}
            ...
            <ul className="space-y-2">
              {(data.offersPending ?? []).slice(0, 5).map((offer) => (
                ...
                >
                  ...
                  <Link
                    to={ROUTES.recruitmentCandidateDetail(offer.candidateLeadId)}
