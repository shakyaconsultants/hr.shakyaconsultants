    ...
    <div className="space-y-6">
      ...
      {editing ? (
        <section className="rounded-lg border bg-card p-4 space-y-3">
          <h2 className="font-semibold">{editing === 'new' ? 'Create Workflow' : 'Edit Workflow'}</h2>
          ...
          <div className="space-y-2">
            ...
            {form.stages.map((stage, index) => (
              <div key={stage.slug} className="grid gap-2 md:grid-cols-4">
          ...
          <div className="flex gap-2">
            <Button onClick={() => void saveWorkflow()} disabled={createMutation.isPending || updateMutation.isPending}>Save</Button>
